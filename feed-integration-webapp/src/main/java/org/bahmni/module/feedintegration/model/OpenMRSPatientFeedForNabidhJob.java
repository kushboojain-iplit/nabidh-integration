...
@Entity
@Table(name = "openmrsPatientFeedForNabidhJob")
public class OpenMRSPatientFeedForNabidhJob {
    ...
    public OpenMRSPatientFeedForNabidhJob() {
    }

    public OpenMRSPatientFeedForNabidhJob(Integer id, String name, Boolean enabled, String cronStatement, Integer startDelay) {
        this.id = id;
        this.name = name;
